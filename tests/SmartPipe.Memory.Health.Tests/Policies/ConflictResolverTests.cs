...
public sealed class ConflictResolverTests : IAsyncDisposable
{
    ...
    public async Task ResolveAsync_WeakensExistingEdge()
    {
        ...
        var edge = await store.UpsertEdgeAsync(new Edge
        {
            FromNodeId = "n1",
            ToNodeId = "n2",
    ...
    // After resolve the edge should not be visible in the future
        ...
        await foreach (var e in store.QueryEdgesAsOfAsync(
            new Model.MemoryQuery(),
            clock.UtcNow))
        {
            edgesAfter.Add(e);
        }
    ...
    {
        var edge1 = new Edge { FromNodeId = "A", ToNodeId = "B", Type = EdgeType.DerivedFrom, ValidFrom = DateTime.UtcNow.AddDays(-2) };
        var edge2 = new Edge { FromNodeId = "A", ToNodeId = "B", Type = EdgeType.DerivedFrom, ValidFrom = DateTime.UtcNow };
    ...
    {
        var edge1 = new Edge { FromNodeId = "A", ToNodeId = "B", Type = EdgeType.DerivedFrom, ValidFrom = DateTime.UtcNow };
        var edge2 = new Edge { FromNodeId = "A", ToNodeId = "B", Type = EdgeType.DuplicateOf, ValidFrom = DateTime.UtcNow };
    ...
    {
        var edge1 = new Edge { FromNodeId = "A", ToNodeId = "B", Type = EdgeType.DerivedFrom, ValidFrom = DateTime.UtcNow };
        var edge2 = new Edge { FromNodeId = "A", ToNodeId = "C", Type = EdgeType.DerivedFrom, ValidFrom = DateTime.UtcNow };
